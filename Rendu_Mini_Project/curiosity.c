...
int main(int argc, char ** argv) {
  ...
  switch(res) {
  case OK_ROBOT: printf("Robot sur une case libre, programme non termin� (ne devrait pas arriver)\n"); break;
  case SORTIE_ROBOT: printf("Le robot est sorti :-)\n"); break;
  case ARRET_ROBOT: printf("Robot sur une case libre, programme termin� :-/\n"); break;
  case PLOUF_ROBOT: printf("Le robot est tomb� dans l'eau :-(\n"); break;
  case CRASH_ROBOT: printf("Le robot s'est �cras� sur un rocher X-(\n"); break;
