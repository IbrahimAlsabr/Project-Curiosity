...
// indexation utilisÃ©e : 
//  1er  indice : abscisse = colonne (colonne de gauche : abscisse = 0)
//  2Ã¨me indice : ordonnÃ©e = ligne   (ligne du haut     : ordonnÃ©e = 0)
...
/* Lecture d'un terrain dans un fichier de nom nom_f
   ...
   Renvoie :
   OK si la lecture s'est dÃ©roulÃ©e correctement
   ERREUR_FICHIER si le fichier n'a pas pu Ãªtre ouvert
   ... (Ã  complÃ©ter)
 */
...
/* Indique si la case de coordonnÃ©es (x,y) est libre
